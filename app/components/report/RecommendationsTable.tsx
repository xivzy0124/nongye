        ...
        <table className="w-full text-left border-collapse">
          <thead className="sticky top-0 z-10">
            <tr className="text-[10px] text-cyan-400/80 border-b border-cyan-500/20 bg-[#08101e]/95">
              <th className="py-1 pl-2 font-medium">优先级</th>
              <th className="py-1 font-medium">类别</th>
              <th className="py-1 font-medium">建议内容</th>
              <th className="py-1 font-medium">预期影响</th>
              <th className="py-1 pr-2 font-medium text-right">置信度</th>
            </tr>
          </thead>
              ...
              return (
                ...
                >
                  <td className="py-1 pl-2">
                    <span className={`inline-block px-1 py-0.5 rounded-[4px] text-[9px] border ${p.bg} ${p.text} ${p.border}`}>
                      {p.label}
                    </span>
                  </td>
                  <td className="py-1 text-cyan-200/90">{rec.category}</td>
                  <td className="py-1 text-cyan-100 pr-2">
                    <span className="group-hover:text-cyan-300 transition-colors">{rec.title}</span>
                  </td>
                  <td className="py-1 text-green-400/90">{rec.impact}</td>
                  <td className="py-1 pr-2 text-right">
                    <div className="inline-flex items-center gap-1">
                      ...
                      <span className="text-cyan-300 text-[9px]">{rec.confidence}%</span>
                    </div>
                  </td>
                </tr>
              );
